...
public class ClockViewGroup extends LinearLayout {
    ...
    private void startNewSteadyAnim(){
        ...
        PropertyValuesHolder holderRotateX =
                PropertyValuesHolder.ofFloat(propertyNameRotateX,mCanvasRotateX,0);

        PropertyValuesHolder holderRotateY =
                PropertyValuesHolder.ofFloat(propertyNameRotateY,mCanvasRotateY,0);
